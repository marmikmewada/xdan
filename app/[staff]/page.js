    ...
    <div className="min-h-screen bg-gray-100">
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Staff Dashboard - {staff}</h1>
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2">
            {/* Store Box */}
            <Link href={`/store/${staff}`} className="bg-white overflow-hidden shadow-lg rounded-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-sm text-gray-500">Manage store related tasks for {staff}</p>
                  </div>
                </div>
              </div>
            </Link>
              ...
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-sm text-gray-500">Manage user related tasks for {staff}</p>
                  </div>
                </div>
              </div>
            </Link>
